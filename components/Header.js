...
import testio from '../assets/testio.png'
    ...
    return <div className={style.wrapper}>
        <Link href='/'>
            <div className={style.logoContainer}>
                <Image src={testio} height={25} width={50}/>
                <div className={style.logoText}>OpenDesigns</div>
            </div>
        </Link>
        ...
        <div className={style.headerItems}>
            ...
            <Link href='/collections/0x292D4a8E48957ea6D94BF11Ac3c9033bFaC5c5Ea'>
